---
title: "Predicting the Outcome of Elections"
subtitle: "A Study Utilizing Generalised Linear Model"
author: 
  - Yuchao Niu

thanks: "Code and data are available at: https://github.com/MelanieNiu/politics"
date: today
date-format: long
format: pdf
...
library(modelsummary)
# 
# # Example using a posterior sample array `posterior_samples` from your Bayesian model
# mcmc_intervals(first_model, prob = 0.9) +
